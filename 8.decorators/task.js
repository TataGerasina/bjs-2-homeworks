...
function debounceDecoratorNew(functionToDecorate, delay) {
	...
	wrapper.count = 0; // хранилось количество вызовов декорированной функции
	wrapper.allCount = 0; // хранилось количество вызовов декоратора

	function wrapper(...args) {
		if (timeoutId) {
			console.log("таймаут есть", args);
...
const sendSignal = (signalOrder, delay) => console.log("Сигнал отправлен", signalOrder, delay);  // signalOrder = Подача сигнала, delay = задержка
